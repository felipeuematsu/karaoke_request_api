...
class _$SongModelImpl implements _SongModel {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, songId, title, artist, path,
      filename, searchString, duration, plays, lastPlayed, imageUrl);
...
abstract class _SongModel implements SongModel {
  const factory _SongModel(
      ...
      final int? plays,
      final DateTime? lastPlayed,
      final String? imageUrl}) = _$SongModelImpl;
